...
y(:,1) = y(:,2);
y(:,2) = parc;
centros1 = [15.91,15.97,15.91,15.97,13.82,13.21,14.55,13.50,12.92;-34.61,...
    -22.39,-13.78,-0.86,21.90,-0.60,-13.43,-18.97,-35.14];
centros2 = [-0.14,0,-0.01,-0.02,0.05,0.11,-14.99,-14.74,-14.55,-14.91,-14.77,...
    -14.97,-14.79;202.54,49.39,-44.82,-148.54,-233.70,-312.94,266.88,201.27,...
    119.75,37.79,-8.04,-56.07,-104.72];
%% Inicializacao do Algoritmo
% Parametros do algoritmo
r = 0.3; % raio de influencia de um cluster
m = 2; %Ponderamento exponencial para calculo de pertinencias
gama = 0.27; % Ponderamento das informacoes no potencial
...
xlabel('Pitch Motor Voltage (V)','Interpreter','latex')
...
xlabel('$k$','Interpreter','latex')
ylabel('Pitch Angle ($^{\circ}$)','Interpreter','latex')
legend('$y_k^1$','$\hat{y}_k^1$','Interpreter','latex')
grid on
xlim([0 1501])
xticks(0:250:1500)
subplot(2,1,2)
    plot(t,y(:,2),'k',t,ye(:,2),'b--','LineWidth',1)
xlabel('$k$','Interpreter','latex')
ylabel('Yaw Angle ($^{\circ}$)','Interpreter','latex')
legend('$y_k^2$','$\hat{y}_k^2$','Interpreter','latex')
grid on
xlim([0 1501])
xticks(0:250:1500)
...
xlabel('$k$','Interpreter','latex')
ylabel('Pitch Motor Voltage (V)','Interpreter','latex')
grid on
xlim([0 1501])
xticks(0:250:1500)
subplot(2,1,2)
...
xlabel('$k$','Interpreter','latex')
ylabel('Yaw Motor Voltage (V)','Interpreter','latex')
grid on
xlim([0 1501])
xticks(0:250:1500)
